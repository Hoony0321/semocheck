...
public class MemberCategoryServiceTest {
    ...
    public void before() {
        ...
        subCategory3 = categoryService.findSubCategoryByName("main2", "test1");
        subCategory4 = categoryService.findSubCategoryByName("main2", "test2");
        subCategory5 = categoryService.findSubCategoryByName("main3", "test1");
    }
